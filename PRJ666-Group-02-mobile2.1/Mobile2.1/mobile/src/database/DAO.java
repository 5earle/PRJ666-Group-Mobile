package database;
        ...
        import com.foodrive.myapp.userLanded;
    ...
    public void getAll(){
        ...
        connectionRequest = new ConnectionRequest(){
            ...
            protected void readResponse(InputStream in) throws IOException {
                ...
                for (Map<String, Object> obj : content) {
                    people.add(new people((String) obj.get("fname"),(String) obj.get("lname"),(String) obj.get("email"),(String)obj.get("Dob"),(String) obj.get("gender"),(String) obj.get("phone"),(String) obj.get("emergency"),(String) obj.get("postal"), (String) obj.get("hoursTotal"), (String) obj.get("hoursSigned"))
            ...
            protected void postResponse() {
                ...
                uiLibsList.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent evt) {
                        ...
                        System.out.println(currentPeople.getFname());
                        System.out.println(currentPeople.getHoursSigned());
                        System.out.println(currentPeople.getHoursTotal());
